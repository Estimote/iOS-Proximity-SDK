...
#import "FMResultSet_EPX.h"
#import "FMDatabasePool_EPX.h"
...
typedef NS_ENUM(int, FMDBCheckpointMode) {
    ...
    FMDBCheckpointModeRestart  = 2, // SQLITE_CHECKPOINT_REPXART,
...
@interface FMDatabase_EPX : NSObject
...
- (FMResultSet_EPX * _Nullable)executeQuery:(NSString*)sql, ...;
...
- (FMResultSet_EPX * _Nullable)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
- (FMResultSet_EPX * _Nullable)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
...
- (FMResultSet_EPX * _Nullable)executeQuery:(NSString *)sql values:(NSArray * _Nullable)values error:(NSError * _Nullable __autoreleasing *)error;
...
- (FMResultSet_EPX * _Nullable)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary * _Nullable)arguments;


// Documentation forthcoming.
- (FMResultSet_EPX * _Nullable)executeQuery:(NSString *)sql withVAList:(va_list)args;
...
@interface FMStatement_EPX : NSObject {
    void *_statement;
    NSString *_query;
    long _useCount;
    BOOL _inUse;
