...
@interface FMDatabasePool_EPX : NSObject
...
- (void)inDatabase:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db))block;
...
- (void)inTransaction:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db, BOOL *rollback))block;
...
- (void)inExclusiveTransaction:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db, BOOL *rollback))block;
...
- (void)inDeferredTransaction:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db, BOOL *rollback))block;
...
- (void)inImmediateTransaction:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db, BOOL *rollback))block;
...
- (NSError * _Nullable)inSavePoint:(__attribute__((noescape)) void (^)(FMDatabase_EPX *db, BOOL *rollback))block;
...
- (BOOL)databasePool:(FMDatabasePool_EPX*)pool shouldAddDatabaseToPool:(FMDatabase_EPX*)database;
...
- (void)databasePool:(FMDatabasePool_EPX*)pool didAddDatabase:(FMDatabase_EPX*)database;
