...
@interface FMResultSet_EPX : NSObject

@property (nonatomic, retain, nullable) FMDatabase_EPX *parentDB;
...
@property (atomic, retain, nullable) FMStatement_EPX *statement;
...
+ (instancetype)resultSetWithStatement:(FMStatement_EPX *)statement usingParentDatabase:(FMDatabase_EPX*)aDB;
